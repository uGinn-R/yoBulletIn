...
namespace yoBulletIn.Migrations
{
    ...
    [Migration("20221003153139_added_viewcounter_to_items")]
    partial class added_viewcounter_to_items
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("yoBulletIn.Entities.ItemImages", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("yoBulletIn.Entities.PM", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("yoBulletIn.Entities.PM", b =>
                {
                    b.HasOne("yoBulletIn.Entities.Item", null)
                        .WithMany("ItemMesages")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("yoBulletIn.Entities.User", "User")
                        .WithMany("Messages")
                        .HasForeignKey("UserId");
                });
